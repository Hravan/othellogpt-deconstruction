...
uv run python scripts/negation_eval.py \
    --results     ckpts/negation_depth_7b_012/eval_results_held_out.json \
    --train-depths 0,1,2

uv run python scripts/negation_eval.py \
    --results     ckpts/negation_depth_7b_0123/eval_results_held_out.json \
    --train-depths 0,1,2,3

uv run python scripts/negation_eval.py \
    --results     ckpts/negation_depth_7b_01234/eval_results_held_out.json \
